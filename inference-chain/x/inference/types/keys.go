...
var (
	...
	BridgeContractAddressesPrefix     = collections.NewPrefix(25)
	BridgeTransactionsPrefix          = collections.NewPrefix(26)
	WrappedTokenCodeIDPrefix          = collections.NewPrefix(27)
	WrappedTokenMetadataPrefix        = collections.NewPrefix(28)
	WrappedTokenContractsPrefix       = collections.NewPrefix(29)
	WrappedContractReverseIndexPrefix = collections.NewPrefix(30)
	LiquidityPoolPrefix               = collections.NewPrefix(31)
	LiquidityPoolApprovedTokensPrefix = collections.NewPrefix(32)
